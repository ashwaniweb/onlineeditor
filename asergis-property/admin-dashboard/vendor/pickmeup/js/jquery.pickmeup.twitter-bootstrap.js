  ...
  (function($) {
    $.fn.pickmeup_twitter_bootstrap = function(initial_options) {
      ...
      return this.each(function() {
        ...
        return $(this.pickmeup).removeClass('pickmeup').addClass('pickmeup-twitter-bootstrap owl-carousel owl-theme');
      });
    };
    (function() {
      var button, disabled, link_hover, panel, parameter, parameters, selected, style, text_muted, value;
